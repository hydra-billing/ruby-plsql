...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<activerecord>.freeze, ["< 8.1", ">= 7.0"])
      s.add_development_dependency(%q<activerecord-oracle_enhanced-adapter>.freeze, ["< 8.1", ">= 7.0"])
      s.add_development_dependency(%q<simplecov>.freeze, [">= 0"])
      s.add_development_dependency(%q<ruby-oci8>.freeze, ["~> 2.2"])
    else
      s.add_dependency(%q<juwelier>.freeze, ["~> 2.0"])
      s.add_dependency(%q<rspec_junit_formatter>.freeze, [">= 0"])
      s.add_dependency(%q<rake>.freeze, [">= 10.0"])
      s.add_dependency(%q<rspec>.freeze, ["~> 3.1"])
      s.add_dependency(%q<activerecord>.freeze, ["< 8.1", ">= 7.0"])
      s.add_dependency(%q<activerecord-oracle_enhanced-adapter>.freeze, ["< 8.1", ">= 7.0"])
      s.add_dependency(%q<simplecov>.freeze, [">= 0"])
      s.add_dependency(%q<ruby-oci8>.freeze, ["~> 2.2"])
    end
  else
    s.add_dependency(%q<juwelier>.freeze, ["~> 2.0"])
    s.add_dependency(%q<rspec_junit_formatter>.freeze, [">= 0"])
